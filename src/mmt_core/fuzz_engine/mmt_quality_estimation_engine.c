...
application_quality_estimation_t *init_voip_quality_estimation_struct()
{
	...
	register_grade_membership_function_with_metric(voip_loss,
												   init_trapez_center_grade_membership_function(2, 0.5, 2.0, 2.0, 5));
	...
	register_grade_membership_function_with_metric(voip_jitter,
												   init_trapez_center_grade_membership_function(2, 2, 5, 5, 20));
	...
	register_grade_membership_function_with_metric(voip_index,
												   init_trapez_center_grade_membership_function(4, 2, 2.5, 2.5, 3));
	register_grade_membership_function_with_metric(voip_index,
												   init_trapez_center_grade_membership_function(3, 2.5, 3, 3, 3.5));
	register_grade_membership_function_with_metric(voip_index,
												   init_trapez_center_grade_membership_function(2, 3, 3.5, 3.5, 4));
