...
/*void parseNodekpiparameter(xmlNodePtr cur, int grade_value,int membership_function_type, metric_t * metric,
application_quality_estimation_t * application) {
	...
	if (membership_function_type == MMT_TRAPEZ_RIGHT)
		register_grade_membership_function_with_metric(metric, init_trapez_right_grade_membership_function(grade_value,
membership_function_parameters[0], membership_function_parameters[1])); else if (membership_function_type ==
MMT_TRAPEZ_CENTER) register_grade_membership_function_with_metric(metric,
init_trapez_center_grade_membership_function(grade_value, membership_function_parameters[0],
membership_function_parameters[1],membership_function_parameters[2], membership_function_parameters[3])); if
(membership_function_type == MMT_TRAPEZ_LEFT) register_grade_membership_function_with_metric(metric,
init_trapez_left_grade_membership_function(grade_value, membership_function_parameters[0],
membership_function_parameters[1]));
...
void parseNodeparameter(xmlNodePtr cur, int grade_value, int membership_function_type, metric_t *metric)
{
	...
	if (membership_function_type == MMT_TRAPEZ_RIGHT)
		register_grade_membership_function_with_metric(
			metric, init_trapez_right_grade_membership_function(grade_value, membership_function_parameters[0],
																membership_function_parameters[1]));
	else if (membership_function_type == MMT_TRAPEZ_CENTER)
		register_grade_membership_function_with_metric(
			metric, init_trapez_center_grade_membership_function(
						grade_value, membership_function_parameters[0], membership_function_parameters[1],
						membership_function_parameters[2], membership_function_parameters[3]));
	else if (membership_function_type == MMT_TRAPEZ_LEFT)
		register_grade_membership_function_with_metric(
			metric, init_trapez_left_grade_membership_function(grade_value, membership_function_parameters[0],
															   membership_function_parameters[1]));
...
void parseNoderule(xmlNodePtr cur, application_quality_estimation_t *application, rule_t *rule,
...
struct application_quality_estimation_rules_struct *parseNoderules(xmlNodePtr cur,
																   application_quality_estimation_t *application)
{
	/* Those are set but not used:
	int nb_rules;
