...
application_quality_estimation_internal_t * init_new_internal_application_quality_estimation_struct(application_quality_estimation_t * app_q_est) {
    if (app_q_est != NULL) {
        application_quality_estimation_internal_t * app_q_est_internal = (application_quality_estimation_internal_t *) mmt_malloc(sizeof (application_quality_estimation_internal_t));
        if (app_q_est_internal != NULL) {
            ...
            while (temp_metric != NULL) {
                app_q_est_internal->metrics_membership_function_values_matrix[count] = mmt_malloc(temp_metric->nb_grades * sizeof (double));
...
metric_grade_membership_function_t * init_new_grade_membership_function(int membership_function_type, int grade_value, int nb_parameters) {
    metric_grade_membership_function_t * grade_membership_function = (metric_grade_membership_function_t *) mmt_malloc(sizeof (metric_grade_membership_function_t) + nb_parameters * sizeof (double));
