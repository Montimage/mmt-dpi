...
int proto_packet_process(ipacket_t * ipacket, proto_statistics_t * parent_stats, unsigned index) {
    ...
    parent_stats = (proto_statistics_internal_t*)update_proto_stats_on_packet(ipacket, configured_protocol, (proto_statistics_internal_t*)parent_stats, proto_offset);
    ...
    if (is_new_session == NEW_SESSION) {
        parent_stats = (proto_statistics_internal_t*)update_proto_stats_on_new_session(ipacket, configured_protocol, (proto_statistics_internal_t*)parent_stats, is_new_session);
