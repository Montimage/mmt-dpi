 ...
 */
#define MMT_SET_ERROR(code, msg) mmt_set_error(code, __FILE__, __LINE__, __func__, msg)
 ...
 */
#define MMT_CHECK_NOT_NULL(ptr, msg) MMT_CHECK((ptr) != NULL, MMT_ERROR_MEMORY_NULL_PTR, msg)
 ...
 */
#define MMT_CHECK_ALLOC(ptr, msg) MMT_CHECK_NOT_NULL(ptr, msg)
