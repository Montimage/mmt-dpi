 ...
 */
typedef void (*mmt_log_callback_t)(mmt_log_level_t level, mmt_log_category_t category, const char *file, int line,
 ...
 */
void mmt_log(mmt_log_level_t level, mmt_log_category_t category, const char *file, int line, const char *function,
 ...
 */
#define MMT_LOG_ERROR_CAT(cat, ...) mmt_log(MMT_LOG_ERROR, cat, __FILE__, __LINE__, __func__, __VA_ARGS__)

#define MMT_LOG_WARN_CAT(cat, ...) mmt_log(MMT_LOG_WARN, cat, __FILE__, __LINE__, __func__, __VA_ARGS__)

#define MMT_LOG_INFO_CAT(cat, ...) mmt_log(MMT_LOG_INFO, cat, __FILE__, __LINE__, __func__, __VA_ARGS__)

#define MMT_LOG_DEBUG_CAT(cat, ...) mmt_log(MMT_LOG_DEBUG, cat, __FILE__, __LINE__, __func__, __VA_ARGS__)

#define MMT_LOG_TRACE_CAT(cat, ...) mmt_log(MMT_LOG_TRACE, cat, __FILE__, __LINE__, __func__, __VA_ARGS__)
 ...
 */
#define MMT_LOG_TRACE_ENTER() MMT_LOG_TRACE("Entering %s", __func__)

#define MMT_LOG_TRACE_EXIT() MMT_LOG_TRACE("Exiting %s", __func__)

#define MMT_LOG_TRACE_EXIT_WITH(retval) MMT_LOG_TRACE("Exiting %s with return value: %d", __func__, (int)(retval))

/**
 * Performance measurement logging
 */
#define MMT_LOG_PERF(cat, msg, ...) MMT_LOG_INFO_CAT(MMT_LOG_CAT_PERFORMANCE, msg, __VA_ARGS__)

/**
 * Security event logging
 */
#define MMT_LOG_SECURITY(msg, ...) MMT_LOG_WARN_CAT(MMT_LOG_CAT_SECURITY, msg, __VA_ARGS__)
