...
static attribute_metadata_t _attributes_metadata[] = {
    ...
    {OCPP_DATA_FLOW_DURATION,                OCPP_DATA_FLOW_DURATION_ALIAS,                MMT_DATA_FLOAT,    sizeof(float_t),    POSITION_NOT_KNOWN, SCOPE_PACKET, _extraction_att},
    {OCPP_DATA_FLOW_DOWN_UP_RATIO,           OCPP_DATA_FLOW_DOWN_UP_RATIO_ALIAS,           MMT_DATA_FLOAT,    sizeof(float_t),    POSITION_NOT_KNOWN, SCOPE_PACKET, _extraction_att},
    ...
    {OCPP_DATA_FLOW_WEBSOCKET_PACKETS_PER_SECOND, OCPP_DATA_FLOW_WEBSOCKET_PACKETS_PER_SECOND_ALIAS, MMT_DATA_FLOAT, sizeof(float_t), POSITION_NOT_KNOWN, SCOPE_PACKET, _extraction_att},
    {OCPP_DATA_FW_WEBSOCKET_PACKETS_PER_SECOND, OCPP_DATA_FW_WEBSOCKET_PACKETS_PER_SECOND_ALIAS, MMT_DATA_FLOAT, sizeof(float_t), POSITION_NOT_KNOWN, SCOPE_PACKET, _extraction_att},
    {OCPP_DATA_BW_WEBSOCKET_PACKETS_PER_SECOND, OCPP_DATA_BW_WEBSOCKET_PACKETS_PER_SECOND_ALIAS, MMT_DATA_FLOAT, sizeof(float_t), POSITION_NOT_KNOWN, SCOPE_PACKET, _extraction_att},
    {OCPP_DATA_FLOW_WEBSOCKET_BYTES_PER_SECOND, OCPP_DATA_FLOW_WEBSOCKET_BYTES_PER_SECOND_ALIAS, MMT_DATA_FLOAT, sizeof(float_t), POSITION_NOT_KNOWN, SCOPE_PACKET, _extraction_att},
    {OCPP_DATA_FW_WEBSOCKET_BYTES_PER_SECOND, OCPP_DATA_FW_WEBSOCKET_BYTES_PER_SECOND_ALIAS, MMT_DATA_FLOAT, sizeof(float_t), POSITION_NOT_KNOWN, SCOPE_PACKET, _extraction_att},
    {OCPP_DATA_BW_WEBSOCKET_BYTES_PER_SECOND, OCPP_DATA_BW_WEBSOCKET_BYTES_PER_SECOND_ALIAS, MMT_DATA_FLOAT, sizeof(float_t), POSITION_NOT_KNOWN, SCOPE_PACKET, _extraction_att},
    ...
    {OCPP_DATA_FLOW_AVG_OCPP16_SETCHARGINGPROFILE_MINCHARGINGRATE, OCPP_DATA_FLOW_AVG_OCPP16_SETCHARGINGPROFILE_MINCHARGINGRATE_ALIAS, MMT_U32_DATA, sizeof(float_t), POSITION_NOT_KNOWN, SCOPE_PACKET, _extraction_att},
