                ...
                if (str[0] == 'H') {
                    ...
                    if (http_data_analyser == 1) {
                        ...
                        case 'C':
                            switch (str[3]) {
                            case 't':
                                if (mmt_memcmp(str + 1, "ontent-", 7) == 0) {
                                    switch ( str[8] ) {
                                    case 'T':
                                    case 't':
                                        if (
                                            mmt_memcmp(str + 9, "ype: ", 5) == 0) {
