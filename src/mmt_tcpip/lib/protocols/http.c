...
static field_value_attribute_information_t http_attributes_info[HTTP_ATTRIBUTES_NB] = {
    ...
    {HTTP_HOST, MMT_HEADER_HOST, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_HOST, http_header_field_value_extraction},
    {HTTP_USER_AGENT, MMT_HEADER_USER_AGENT, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_USER_AGENT, http_header_field_value_extraction},
    {HTTP_ACCEPT, MMT_HEADER_ACCEPT, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_ACCEPT, http_header_field_value_extraction},
    {HTTP_ACCEPT_Charset, MMT_HEADER_ACCEPT_CHARSET, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_ACCEPT_Charset, http_header_field_value_extraction},
    {HTTP_Accept_Encoding, MMT_HEADER_ACCEPT_ENCODING, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Accept_Encoding, http_header_field_value_extraction},
    {HTTP_Accept_Language, MMT_HEADER_ACCEPT_LANGUAGE, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Accept_Language, http_header_field_value_extraction},
    {HTTP_Authorization, MMT_HEADER_AUTHORIZATION, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Authorization, http_header_field_value_extraction},
    {HTTP_Expect, MMT_HEADER_EXPECT, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Expect, http_header_field_value_extraction},
    {HTTP_From, MMT_HEADER_FROM, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_From, http_header_field_value_extraction},
    {HTTP_Date, MMT_HEADER_DATE, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Date, http_header_field_value_extraction},
    {HTTP_P3P, MMT_HEADER_P3P, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_P3P, http_header_field_value_extraction},
    {HTTP_Cache_Control, MMT_HEADER_CACHE_CONTROL, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Cache_Control, http_header_field_value_extraction},
    {HTTP_Connection, MMT_HEADER_CONNECTION, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Connection, http_header_field_value_extraction},
    {HTTP_Transfer_Encoding, MMT_HEADER_TRANSFER_ENCODING, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Transfer_Encoding, http_header_field_value_extraction},
    {HTTP_DNT, MMT_HEADER_DNT, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_DNT, http_header_field_value_extraction},
    {HTTP_Cookie, MMT_HEADER_COOKIE, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Cookie, http_header_field_value_extraction},
    {HTTP_If_Match, MMT_HEADER_IF_MATCH, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_If_Match, http_header_field_value_extraction},
    {HTTP_If_Modified_Since, MMT_HEADER_IF_MODIFIED_SINCE, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_If_Modified_Since, http_header_field_value_extraction},
    {HTTP_If_None_Match, MMT_HEADER_IF_NONE_MATCH, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_If_None_Match, http_header_field_value_extraction},
    {HTTP_If_Range, MMT_HEADER_IF_RANGE, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_If_Range, http_header_field_value_extraction},
    {HTTP_If_Unmodified_Since, MMT_HEADER_IF_UNMODIFIED_SINCE, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_If_Unmodified_Since, http_header_field_value_extraction},
    {HTTP_Max_Forwards, MMT_HEADER_MAX_FORWARDS, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Max_Forwards, http_header_field_value_extraction},
    {HTTP_Proxy_Authorization, MMT_HEADER_PROXY_AUTHORIZATION, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Proxy_Authorization, http_header_field_value_extraction},
    {HTTP_Range, MMT_HEADER_RANGE, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Range, http_header_field_value_extraction},
    {HTTP_Referer, MMT_HEADER_REFERER, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Referer, http_header_field_value_extraction},
    {HTTP_TE, MMT_HEADER_TE, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_TE, http_header_field_value_extraction},
    {HTTP_Accept_Ranges, MMT_HEADER_ACCEPT_RANGES, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Accept_Ranges, http_header_field_value_extraction},
    {HTTP_Age, MMT_HEADER_AGE, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Age, http_header_field_value_extraction},
    {HTTP_ETag, MMT_HEADER_ETAG, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_ETag, http_header_field_value_extraction},
    {HTTP_Location, MMT_HEADER_LOCATION, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Location, http_header_field_value_extraction},
    {HTTP_Proxy_Authenticate, MMT_HEADER_PROXY_AUTHENTICATE, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Proxy_Authenticate, http_header_field_value_extraction},
    {HTTP_Retry_After, MMT_HEADER_RETRY_AFTER, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Retry_After, http_header_field_value_extraction},
    {HTTP_Server, MMT_HEADER_SERVER, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Server, http_header_field_value_extraction},
    {HTTP_Vary, MMT_HEADER_VARY, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Vary, http_header_field_value_extraction},
    {HTTP_WWW_Authenticate, MMT_HEADER_WWW_AUTHENTICATE, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_WWW_Authenticate, http_header_field_value_extraction},
    {HTTP_Allow, MMT_HEADER_ALLOW, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Allow, http_header_field_value_extraction},
    {HTTP_Content_Encoding, MMT_HEADER_CONTENT_ENCODING, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Content_Encoding, http_header_field_value_extraction},
    {HTTP_Content_Language, MMT_HEADER_CONTENT_LANGUAGE, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Content_Language, http_header_field_value_extraction},
    {HTTP_Content_Length, MMT_HEADER_CONTENT_LENGTH, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Content_Length, http_header_field_value_extraction},
    {HTTP_Content_Location, MMT_HEADER_CONTENT_LOCATION, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Content_Location, http_header_field_value_extraction},
    {HTTP_Content_MD5, MMT_HEADER_CONTENT_MD5, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Content_MD5, http_header_field_value_extraction},
    {HTTP_Content_Range, MMT_HEADER_CONTENT_RANGE, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Content_Range, http_header_field_value_extraction},
    {HTTP_Content_Type, MMT_HEADER_CONTENT_TYPE, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Content_Type, http_header_field_value_extraction},
    {HTTP_Expires, MMT_HEADER_EXPIRES, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Expires, http_header_field_value_extraction},
    {HTTP_Last_Modified, MMT_HEADER_LAST_MODIFIED, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_Last_Modified, http_header_field_value_extraction},
    {HTTP_SET_COOKIE, MMT_HEADER_SET_COOKIE, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_SET_COOKIE, http_header_field_value_extraction},
    {HTTP_SET_COOKIE2, MMT_HEADER_SET_COOKIE2, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_SET_COOKIE2, http_header_field_value_extraction},

    {HTTP_VERSION, HTTP_VERSION_SHORT_LABEL, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION, HTTP_NOHEADER, http_version_extraction},
    ...
    {HTTP_METHOD, HTTP_METHOD_SHORT_LABEL, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION_CHANGING, HTTP_NOHEADER, http_method_extraction},
    {HTTP_URI, HTTP_URI_SHORT_LABEL, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION_CHANGING, HTTP_NOHEADER, http_requested_uri_extraction},
    {HTTP_Referer_URL, HTTP_Referer_URL_SHORT_LABEL, MMT_DATA_POINTER, sizeof (void *), POSITION_NOT_KNOWN, SCOPE_SESSION_CHANGING, HTTP_Referer, NULL},
