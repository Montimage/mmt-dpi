...
int init_tcpip_plugin()
{
    ...
    /////////////////////////////////////////////
    /////////// INITILIZING proto_geo_networking //////////////////
    if (!init_proto_geo_networking_struct())
    {
        fprintf(stderr, "Error initializing protocol proto_geo_networking\n Exiting\n");
        exit(0);
    }

    if (!init_proto_btpb_struct())
    {
        fprintf(stderr, "Error initializing protocol proto_btpb\n Exiting\n");
        exit(0);
    }
    ...
    /////////////////////////////////////////////
    /////////// INITILIZING PROTO_JEUXVIDEO //////////////////
    if (!init_proto_jeuxvideo_struct())
    {
        fprintf(stderr, "Error initializing protocol PROTO_JEUXVIDEO\n Exiting\n");
        exit(0);
    }
    /////////////////////////////////////////////
    ...
    /////////////////////////////////////////////
    /////////// INITILIZING PROTO_SABAH //////////////////
    if (!init_proto_sabah_struct())
    {
        fprintf(stderr, "Error initializing protocol proto_sabah\n Exiting\n");
        exit(0);
    }
    /////////////////////////////////////////////
    ...
    /////////////////////////////////////////////
    /////////// INITILIZING PROTO_LEFIGARO //////////////////
    if (!init_proto_lefigaro_struct())
    {
        fprintf(stderr, "Error initializing protocol PROTO_LEFIGARO\n Exiting\n");
        exit(0);
    }
    /////////////////////////////////////////////
    ...
    /////////////////////////////////////////////
    /////////// INITILIZING PROTO_LLMNR //////////////////
    if (!init_proto_llmnr_struct())
    {
    ...
    /////////////////////////////////////////////
    /////////// INITILIZING PROTO_LLC //////////////////
    if (!init_proto_llc_struct())
    {
        fprintf(stderr, "Error initializing protocol PROTO_LLC\n Exiting\n");
        exit(0);
    }
    /////////////////////////////////////////////
    /////////// INITILIZING PROTO_XID //////////////////
    if (!init_proto_xid_struct())
    {
        fprintf(stderr, "Error initializing protocol PROTO_XID\n Exiting\n");
        exit(0);
    }
    /////////////////////////////////////////////
    /////////// INITILIZING PROTO_CDP //////////////////
    if (!init_proto_cdp_struct())
    {
        fprintf(stderr, "Error initializing protocol PROTO_CDP\n Exiting\n");
        exit(0);
    }
    /////////////////////////////////////////////
    /////////// INITILIZING PROTO_DTP //////////////////
    if (!init_proto_dtp_struct())
    {
        fprintf(stderr, "Error initializing protocol PROTO_DTP\n Exiting\n");
        exit(0);
    }
    if (!init_proto_inband_network_telemetry_struct())
    {
