...
static const protocol_match doted_host_names[] = {
    ...
    {".mobile.bg", PROTO_MOBILE, MMT_STATICSTRING_LEN(".mobile.bg")},
    {".www.mobile.bg", PROTO_MOBILE, MMT_STATICSTRING_LEN(".www.mobile.bg")},
    ...
    {".mobile.de", PROTO_MOBILE, MMT_STATICSTRING_LEN(".mobile.de")},
    {".www.mobile.de", PROTO_MOBILE, MMT_STATICSTRING_LEN(".www.mobile.de")},
