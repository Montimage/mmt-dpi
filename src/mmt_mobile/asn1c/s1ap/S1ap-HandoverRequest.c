...
static int
memb_s1ap_HandoverRequest_ies_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_oer_constraints_t asn_OER_type_s1ap_HandoverRequest_ies_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..65535)) */};
static asn_per_constraints_t asn_PER_type_s1ap_HandoverRequest_ies_constr_2 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 16,  16,  0,  65535 }	/* (SIZE(0..65535)) */,
	0, 0	/* No PER value map */
};
static asn_oer_constraints_t asn_OER_memb_s1ap_HandoverRequest_ies_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(0..65535)) */};
static asn_per_constraints_t asn_PER_memb_s1ap_HandoverRequest_ies_constr_2 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 16,  16,  0,  65535 }	/* (SIZE(0..65535)) */,
	0, 0	/* No PER value map */
};
...
asn_TYPE_descriptor_t asn_DEF_s1ap_HandoverRequest_ies_2 = {
	...
	{ &asn_OER_type_s1ap_HandoverRequest_ies_constr_2, &asn_PER_type_s1ap_HandoverRequest_ies_constr_2, SEQUENCE_OF_constraint },
...
static asn_TYPE_member_t asn_MBR_S1ap_HandoverRequest_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct S1ap_HandoverRequest, s1ap_HandoverRequest_ies),
		...
		0,
		{ &asn_OER_memb_s1ap_HandoverRequest_ies_constr_2, &asn_PER_memb_s1ap_HandoverRequest_ies_constr_2,  memb_s1ap_HandoverRequest_ies_constraint_1 },
		0, 0, /* No default value */
		"s1ap-HandoverRequest-ies"
		},
};
