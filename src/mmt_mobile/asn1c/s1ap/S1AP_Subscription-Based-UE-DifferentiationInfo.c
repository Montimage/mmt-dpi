...
static asn_oer_constraints_t asn_OER_type_S1AP_periodicCommunicationIndicator_constr_2 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_S1AP_stationaryIndication_constr_8 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_S1AP_trafficProfile_constr_12 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_type_S1AP_batteryIndication_constr_17 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
static asn_oer_constraints_t asn_OER_memb_S1AP_periodicTime_constr_6 CC_NOTUSED = {
	{ 0, 0 },
	-1};
...
asn_TYPE_descriptor_t asn_DEF_S1AP_periodicCommunicationIndicator_2 = {
	...
	{ &asn_OER_type_S1AP_periodicCommunicationIndicator_constr_2, &asn_PER_type_S1AP_periodicCommunicationIndicator_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_S1AP_stationaryIndication_8 = {
	...
	{ &asn_OER_type_S1AP_stationaryIndication_constr_8, &asn_PER_type_S1AP_stationaryIndication_constr_8, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_S1AP_trafficProfile_12 = {
	...
	{ &asn_OER_type_S1AP_trafficProfile_constr_12, &asn_PER_type_S1AP_trafficProfile_constr_12, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_S1AP_batteryIndication_17 = {
	...
	{ &asn_OER_type_S1AP_batteryIndication_constr_17, &asn_PER_type_S1AP_batteryIndication_constr_17, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_S1AP_batteryIndication_specs_17	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_S1AP_Subscription_Based_UE_DifferentiationInfo_1[] = {
	...
	{ ATF_POINTER, 6, offsetof(struct S1AP_Subscription_Based_UE_DifferentiationInfo, periodicTime),
		...
		0,
		{ &asn_OER_memb_S1AP_periodicTime_constr_6, &asn_PER_memb_S1AP_periodicTime_constr_6,  memb_S1AP_periodicTime_constraint_1 },
		0, 0, /* No default value */
		"periodicTime"
		},
	...
	{ ATF_POINTER, 1, offsetof(struct S1AP_Subscription_Based_UE_DifferentiationInfo, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_S1AP_ProtocolExtensionContainer_7378P112,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
static asn_SEQUENCE_specifics_t asn_SPC_S1AP_Subscription_Based_UE_DifferentiationInfo_specs_1 = {
