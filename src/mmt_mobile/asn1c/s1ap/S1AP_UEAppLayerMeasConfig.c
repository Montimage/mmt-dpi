...
static asn_TYPE_member_t asn_MBR_S1AP_UEAppLayerMeasConfig_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct S1AP_UEAppLayerMeasConfig, containerForAppLayerMeasConfig),
		...
		0,
		{ &asn_OER_memb_S1AP_containerForAppLayerMeasConfig_constr_2, &asn_PER_memb_S1AP_containerForAppLayerMeasConfig_constr_2,  memb_S1AP_containerForAppLayerMeasConfig_constraint_1 },
	...
	{ ATF_POINTER, 1, offsetof(struct S1AP_UEAppLayerMeasConfig, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_S1AP_ProtocolExtensionContainer_7378P136,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
