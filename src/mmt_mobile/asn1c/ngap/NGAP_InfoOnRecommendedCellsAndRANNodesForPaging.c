...
static asn_TYPE_member_t asn_MBR_NGAP_InfoOnRecommendedCellsAndRANNodesForPaging_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_NGAP_InfoOnRecommendedCellsAndRANNodesForPaging_specs_1 = {
