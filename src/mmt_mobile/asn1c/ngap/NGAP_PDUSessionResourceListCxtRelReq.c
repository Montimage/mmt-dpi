...
static asn_oer_constraints_t asn_OER_type_NGAP_PDUSessionResourceListCxtRelReq_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1	/* (SIZE(1..256)) */};
static asn_per_constraints_t asn_PER_type_NGAP_PDUSessionResourceListCxtRelReq_constr_1 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 8,  8,  1,  256 }	/* (SIZE(1..256)) */,
	0, 0	/* No PER value map */
};
static asn_TYPE_member_t asn_MBR_NGAP_PDUSessionResourceListCxtRelReq_1[] = {
	{ ATF_POINTER, 0, 0,
...
static asn_SET_OF_specifics_t asn_SPC_NGAP_PDUSessionResourceListCxtRelReq_specs_1 = {
