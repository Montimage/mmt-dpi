...
static asn_oer_constraints_t asn_OER_type_NGAP_LocationReportingAdditionalInfo_constr_1 CC_NOTUSED = {
	{ 0, 0 },
	-1};
static asn_per_constraints_t asn_PER_type_NGAP_LocationReportingAdditionalInfo_constr_1 CC_NOTUSED = {
...
static const asn_INTEGER_specifics_t asn_SPC_NGAP_LocationReportingAdditionalInfo_specs_1 = {
